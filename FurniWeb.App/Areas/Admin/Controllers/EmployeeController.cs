...
namespace FurniWeb.App.Areas.Admin.Controllers
{
    ...
    public class EmployeeController : Controller
    {
        ...
        private readonly IPositionReadRepository _positonRead;
        private readonly AppDbContext _context;
        public EmployeeController(IEmployeeWriteRepository employeeWrite, IEmployeeReadRepository employeeRead, PositionReadRepository positonRead, AppDbContext context)
        {
        ...
        public async Task<IActionResult> Create(EmployeeCreateDto dto)
        {
            ...
            ViewBag.Positions = await _positonRead.FilterAll(static p => !p.IsDeleted).ToListAsync();
